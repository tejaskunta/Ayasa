      ...
      <header className="navbar">
        ...
        <div className="navbar-right">
          ...
          <button className="btn-logout" onClick={handleLogout}>
            <span className="material-symbols-outlined" style={{ fontSize: '1rem', verticalAlign: 'middle', marginRight: '0.3rem' }}>logout</span>
            Logout
          </button>
        </div>
      </header>
        ...
        <div className="home-bottom">
          ...
          <div className="recommendation-card">
            ...
            <div className="rec-content">
              <h3>Nature Sounds</h3>
              <p>
                <span className="material-symbols-outlined" style={{ fontSize: '0.9rem', verticalAlign: 'middle' }}>music_note</span>
                {' '}Recommended for you
              </p>
            </div>
          </div>
